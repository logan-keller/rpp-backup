...
YoungsterData:
	...
	db "Josh@",17,RATICATE,RATICATE,RATICATE,$FF
...
LassData:
	...
	db "Jennifer@",10,RATICATE,NIDORAN_M,$FF
	...
	db "Rose@",18,CLEFABLE,JOLTEON,$FF
...
SuperNerdData:
	...
	db "Eric@",16,PIKACHU,VAPOREON,$FF
...
EngineerData:
	...
	db "Flint@",21,MAGNEMITE,MAGNEMITE,$FF
...
SwimmerData:
	...
	db "Ben@",32,MAGNEMITE,MAGNETON,STARMIE,$FF
...
SwimmerFData:
BeautyData:
	db "Charlotte@",24,ODDISH,GLOOM,VILEPLUME,$FF
...
PsychicData:
	...
	db "Kio@",33,SLOWPOKE,SLOWBRO,SLOWBRO,$FF
	db "Rhen@",38,SLOWBRO,$FF
...
BirdKeeperData:
	...
	db "Jim@",26,SPEAROW,SPEAROW,SPEAROW,FEAROW,$FF
	db "Eric@",29,PIDGEOTTO,FEAROW,$FF
	db "Chris@",28,SPEAROW,SPEAROW,FEAROW,$FF
...
RocketData:
	...
	db "Executive@",CUSTOM_PIC,EXECUTIVE_M,23,GROWLITHE,FEAROW,KOFFING,$FF
