UniqueDVTrainerPokemon:
	...
	; shiny
	db SUPER_NERD, 2, VAPOREON, 20, ATKDEFDV_SHINY, SPDSPCDV_SHINY
	db LANCE, 1, DRAGONITE, 79, ATKDEFDV_SHINY, SPDSPCDV_SHINY
	db BEAUTY, 1, VILEPLUME, 41, ATKDEFDV_SHINY_FEMALE, SPDSPCDV_SHINY
	db LASS, 11, JOLTEON, 25, ATKDEFDV_SHINY_FEMALE, SPDSPCDV_SHINY
	
	; other
	db YOUNGSTER, 1, RATICATE, 14, $FF, $FF ; Ben's Top Percentage Zigzagoon
