UniqueDVTrainerPokemon:
	...
	; shiny
	db SUPER_NERD, 2, VAPOREON, 16, ATKDEFDV_SHINY, SPDSPCDV_SHINY
	db LANCE, 1, DRAGONITE, 62, ATKDEFDV_SHINY, SPDSPCDV_SHINY
	db BEAUTY, 1, VILEPLUME, 24, ATKDEFDV_SHINY_FEMALE, SPDSPCDV_SHINY
	db LASS, 11, JOLTEON, 18, ATKDEFDV_SHINY_FEMALE, SPDSPCDV_SHINY
	
	; other
	db YOUNGSTER, 1, RATICATE, 11, $FF, $FF ; Ben's Top Percentage Zigzagon
