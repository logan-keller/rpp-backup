...
;GOLBAT
;Evolutions
	db EV_ITEM,MOON_STONE,1,GOLBAT
	db 0
;Learnset
	db 1,SCREECH
	db 1,ABSORB
...
;Evolutions
	...
	db EV_ITEM,SUN_STONE,1,VILEPLUME
	db 0
;Learnset
	db 1,ABSORB
	db 5,GROWTH
...
;Evolutions
	...
	db EV_ITEM,MOON_STONE,1,POLIWRATH
	db 0
;Learnset
	db 1,MUD_SLAP ; Water Sport → TM move
	db 5,WATER_GUN
...
;SLOWPOKE
;Evolutions
	db EV_ITEM,MOON_STONE,1,SLOWBRO
...
;MAGNETON
;Evolutions
	db EV_MAP,POWER_PLANT,MAGNETON
	db 0
;Learnset
...
;LICKITUNG
;Evolutions
	db EV_MOVE,ANCIENTPOWER,LICKITUNG
	db 0
;Learnset
	db 1,LICK
	db 5,SUPERSONIC
...
;RHYDON
;Evolutions
	db EV_MOVE,ANCIENTPOWER,RHYDON
	db 0
;Learnset
	db 1,HORN_ATTACK
	db 1,TAIL_WHIP
...
;CHANSEY
;Evolutions
	db EV_ITEM,SUN_STONE,1,CHANSEY
	db 0
;Learnset
	db 1,DEFENSE_CURL
	db 1,POUND
...
;TANGELA
;Evolutions
	db EV_MOVE,ANCIENTPOWER,TANGELA
	db 0
;Learnset
	db 1,CONSTRICT
	db 4,SLEEP_POWDER
...
;SEADRA
;Evolutions
	db EV_ITEM,WATER_STONE,1,SEADRA
	db 0
;Learnset
	db 1,BUBBLE
	db 5,SMOKESCREEN
...
;ELECTABUZZ
;Evolutions
	db EV_MAP,POWER_PLANT,ELECTABUZZ
	db 0
;Learnset
	db 1,QUICK_ATTACK
	db 1,LEER
...
;MAGMAR
;Evolutions
	db EV_MAP,MANSION_1,MAGMAR
	db EV_MAP,MANSION_2,MAGMAR
	db EV_MAP,MANSION_3,MAGMAR
	db EV_MAP,MANSION_4,MAGMAR
	db 0
;Learnset
	db 1,SMOG
	db 1,LEER
...
;Evolutions
	...
	db EV_ITEM,MOON_STONE,1,VAPOREON
	db EV_ITEM,SUN_STONE,1,JOLTEON
	db EV_MAP,VIRIDIAN_FOREST,VICTREEBEL ; The only map lol
	db EV_MAP,SEAFOAM_ISLANDS_5,DEWGONG ; The floor with Articuno
	db EV_MAP,MT_MOON_SQUARE,CLEFABLE ; Because that's where the meteor landed
	db 0
Mon133_EvosEnd:
;Learnset
	db 1,TACKLE
...
;PORYGON
;Evolutions
	db EV_ITEM,THUNDER_STONE,1,PORYGON
	db 0
;Learnset
	db 1,TACKLE
	db 1,CONVERSION
